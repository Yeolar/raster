...
private:
  ...
  int interruptSockWriter_;                          // is notified on interrupt()
  int interruptSockReader_;                          // is used in select/poll with serverSocket_ for interruptability
  int childInterruptSockWriter_;                     // is notified on interruptChildren()
  boost::shared_ptr<int> pChildInterruptSockReader_; // if interruptableChildren_ this is shared with child TSockets
