...
template<>
struct hash< ::rdd::dynamic> {
  size_t operator()(::rdd::dynamic const& d) const {
    return d.hash();
  }
};
...
#define RDD_DYNAMIC_INTEGER_OP(op)                          \
...
RDD_DYNAMIC_INTEGER_OP(%=)
RDD_DYNAMIC_INTEGER_OP(|=)
RDD_DYNAMIC_INTEGER_OP(&=)
RDD_DYNAMIC_INTEGER_OP(^=)

#undef RDD_DYNAMIC_INTEGER_OP
...
#define RDD_DYNAMIC_DEC_TYPEINFO(T, str, val) \
...
RDD_DYNAMIC_DEC_TYPEINFO(void*,               "null",    dynamic::NULLT)
RDD_DYNAMIC_DEC_TYPEINFO(bool,                "boolean", dynamic::BOOL)
RDD_DYNAMIC_DEC_TYPEINFO(std::string,         "string",  dynamic::STRING)
RDD_DYNAMIC_DEC_TYPEINFO(dynamic::Array,      "array",   dynamic::ARRAY)
RDD_DYNAMIC_DEC_TYPEINFO(double,              "double",  dynamic::DOUBLE)
RDD_DYNAMIC_DEC_TYPEINFO(int64_t,             "int64",   dynamic::INT64)
RDD_DYNAMIC_DEC_TYPEINFO(dynamic::ObjectImpl, "object",  dynamic::OBJECT)

#undef RDD_DYNAMIC_DEC_TYPEINFO
...
#define RDD_X(T) PrintImpl<T>::print(*this, out, *getAddress<T>())
