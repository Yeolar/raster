...
const ::google::protobuf::ServiceDescriptor* ProxyService_descriptor_ = NULL;
...
void protobuf_AssignDesc_Proxy_2eproto() {
  ...
  static const int Query_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Query, forward_),
  };
  Query_reflection_ =
  ...
  ProxyService_descriptor_ = file->service(0);
}
...
void protobuf_AddDesc_Proxy_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013Proxy.proto\022\trdd.pbrpc\"8\n\005Query\022\017\n\007tra"
    "ceid\030\001 \002(\t\022\r\n\005query\030\002 \001(\t\022\017\n\007forward\030\003 \001"
    "(\t\">\n\006Result\022\017\n\007traceid\030\001 \002(\t\022#\n\004code\030\002 "
    "\001(\0162\025.rdd.pbrpc.ResultCode*F\n\nResultCode"
    "\022\006\n\002OK\020\000\022\030\n\023E_SOURCE__UNTRUSTED\020\351\007\022\026\n\021E_"
    "BACKEND_FAILURE\020\352\0072:\n\014ProxyService\022*\n\003ru"
    "n\022\020.rdd.pbrpc.Query\032\021.rdd.pbrpc.ResultB\003"
    "\200\001\001", 283);
...
const int Query::kForwardFieldNumber;
#endif  // !_MSC_VER
      ...
      case 3: {
        if (tag == 26) {
         parse_forward:
          ...
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->forward().data(), this->forward().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "forward");
        } else {
          goto handle_unusual;
...
const ::google::protobuf::ServiceDescriptor* ProxyService::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ProxyService_descriptor_;
}
...
void ProxyService::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), ProxyService_descriptor_);
  switch(method->index()) {
    case 0:
      run(controller,
