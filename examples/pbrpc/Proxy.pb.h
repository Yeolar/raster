...
const ResultCode ResultCode_MAX = E_BACKEND_FAILURE;
...
class Query : public ::google::protobuf::Message {
 public:
  ...
  inline const ::std::string& forward() const;
  inline void set_forward(const ::std::string& value);
  inline void set_forward(const char* value);
  inline void set_forward(const char* value, size_t size);
  inline ::std::string* mutable_forward();
  inline ::std::string* release_forward();
  inline void set_allocated_forward(::std::string* forward);
...
// optional string forward = 3;
inline bool Query::has_forward() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Query::set_has_forward() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Query::clear_has_forward() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Query::clear_forward() {
  if (forward_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    forward_->clear();
  }
  clear_has_forward();
}
inline const ::std::string& Query::forward() const {
  // @@protoc_insertion_point(field_get:rdd.pbrpc.Query.forward)
  return *forward_;
}
inline void Query::set_forward(const ::std::string& value) {
  set_has_forward();
  if (forward_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    forward_ = new ::std::string;
  }
  forward_->assign(value);
  // @@protoc_insertion_point(field_set:rdd.pbrpc.Query.forward)
}
inline void Query::set_forward(const char* value) {
  set_has_forward();
  if (forward_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    forward_ = new ::std::string;
  }
  forward_->assign(value);
  // @@protoc_insertion_point(field_set_char:rdd.pbrpc.Query.forward)
}
inline void Query::set_forward(const char* value, size_t size) {
  set_has_forward();
  if (forward_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    forward_ = new ::std::string;
  }
  forward_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:rdd.pbrpc.Query.forward)
}
inline ::std::string* Query::mutable_forward() {
  set_has_forward();
  if (forward_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    forward_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:rdd.pbrpc.Query.forward)
  return forward_;
}
inline ::std::string* Query::release_forward() {
  clear_has_forward();
  if (forward_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = forward_;
    forward_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void Query::set_allocated_forward(::std::string* forward) {
  if (forward_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete forward_;
  }
  if (forward) {
  ...
  // @@protoc_insertion_point(field_set_allocated:rdd.pbrpc.Query.forward)
}
