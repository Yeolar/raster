...
#ifndef RDD_GEN_BASE_H
#error This file may only be included from raster/gen/Base.h
#endif
...
/**
 * RangeSource - For producing values from a rdd::Range. Useful for referring
 * to a slice of some container.
 *
 * This type is primarily used through the 'from' function, like:
 *
 *   auto rangeSource = from(rdd::range(v.begin(), v.end()));
...
class RangeSource : public GenImpl<typename Range<Iterator>::reference,
 ...
 public:
  ...
  // rdd::Range only supports finite ranges
  static constexpr bool infinite = false;
};
...
/**
 * UnwrapOr - For unwrapping rdd::Optional values, or providing the given
...
/**
 * Unwrap - For unwrapping rdd::Optional values in a rdd::gen style. Usually
