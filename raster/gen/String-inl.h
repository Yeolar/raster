...
#ifndef RDD_GEN_STRING_H
#error This file may only be included from raster/gen/String.h
#endif
...
bool StreamSplitter<Callback>::flush() {
  RDDCHECK(maxLength_ == 0 || buffer_.length() < maxLength_);
